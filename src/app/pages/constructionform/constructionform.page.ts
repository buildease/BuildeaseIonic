...
@Component({
  ...
  templateUrl: './constructionform.page.html',
  styleUrls: ['./constructionform.page.scss'],
})
export class ConstructionformPage implements OnInit {
  plannings: string[] = [];
  planningFor:any;
  name:any;
  email:any;
  ...
  submitdata(formValue: any) {
    ...
    this.getListService.constructionAppointment(appointmentdata).subscribe(
      rdata => {
