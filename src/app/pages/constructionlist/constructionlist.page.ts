...
@Component({
  selector: 'app-constructionlist',
  templateUrl: './constructionlist.page.html',
  styleUrls: ['./constructionlist.page.scss'],
})
export class ConstructionlistPage implements OnInit {
  selectedSlide: any;
  segment = 0;
  sliderOptions = {
    initialSlide: 0,
